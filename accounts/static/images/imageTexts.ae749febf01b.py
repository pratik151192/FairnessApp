...
acceptor_names = ['Monica', 'Chandler', 'Joey', 'Phoebe', 'Rachel', 'Ross']
offeror_names = ['Eric', 'Sloan', 'Vince', 'Ari', 'Shauna', 'Amanda']
settings = {
    0: 'Private/Only Me',
    0.25: 'Friends',
...
def getOfferorNames():
    return offeror_names

def getAcceptorNames():
    return acceptor_names
